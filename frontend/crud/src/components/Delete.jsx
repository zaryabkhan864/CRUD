...
const Delete = () => {
    const myitems = [
        { "Computer": "I 5", "Color": "Green", "Category": "Laptop", "Price": "1500" },
        { "Computer": "I 5", "Color": "Green", "Category": "Computer", "Price": "1500" },
        { "Computer": "I 5", "Color": "Green", "Category": "Laptop", "Price": "1500" },
        { "Computer": "I 5", "Color": "Green", "Category": "PC", "Price": "1500" },
    ]
    const [mydata, setData] = useState(myitems);

    return (
        <div className='container justify-center mx-auto'>
            <div className='my-5 p-5'>
                <span className='font-bold from-neutral-900'>Delete your records</span>
            </div>
